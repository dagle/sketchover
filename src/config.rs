...
//         );
//         key_map.insert(KeyMap::new("b", Modifiers::default()), Command::ToggleFg);
...
//             alt_background: String::from("#80808000"),
